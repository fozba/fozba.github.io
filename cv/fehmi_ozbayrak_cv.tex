...
\begin{cvitems}
  \item Architected and implemented a modular Python platform for geothermal field-development planning, integrating machine-learning temperature forecasts, physical asset objects, daily simulations, project economics, and drilling-schedule optimization.
  \item Developed the platform from a new code base and structured it for configurable scenario analysis and handoff to other engineers.
  \item Optimized drilling start times for revenue maximization under power-delivery constraints and built interactive Plotly and Dash analysis tools.
\end{cvitems}

\cventry{Graduate Research Assistant}{DiReCT Consortium, The University of Texas at Austin}{Austin, Texas}{Aug 2022-May 2024}
\begin{cvitems}
...
\begin{compactitems}
  \item ``An accessible, quality-transparent workflow for geological poromechanics with MOOSE.'' Manuscript in preparation; not submitted.
  \item ``Induced fracture geometry and vertical containment during shallow wastewater injection in the Delaware Mountain Group: A calibrated geomechanical modeling study.'' Manuscript in preparation; title and author order subject to coauthor review.
\end{compactitems}

\cvsection{Research Software and Selected Research Projects}
\cvproject{Auditable Geological Poromechanics Workflow (JAVELINA)}{2026}
\begin{cvitems}
  ...
  \item Verified generated operators against six analytical, semi-analytical, and manufactured benchmarks, including near-second-order spatial convergence.
\end{cvitems}
...
\cvsection{Awards and Technical Competition Projects}
\cvproject{Utah FORGE Engineering Analysis, GEODE Engineering Datathon}{Second place · 2025 · Two-person team}
\begin{compactitems}
  \item Wrote the analysis code integrating tracer, distributed fiber-optic temperature, strain and acoustic data, microseismicity, well surveys, and stimulation records to infer stage-level connectivity and preferential flow paths and support a targeted restimulation proposal.
\end{compactitems}

\cvproject{Nevada Blind-Geothermal Exploration, GEODE Geosciences Datathon}{Second place · 2025 · Two-person team}
\begin{compactitems}
  \item Built a spatial CNN workflow using strain, gravity, permeability, modeled temperature, earthquake density, and fault-distance rasters with geographically separated development and validation regions.
\end{compactitems}

\cvproject{Hydraulic-Fracturing Fuel Forecast, UT PGE Energy AI Hackathon}{First place · 2025 · Five-person team}
\begin{compactitems}
...
\cvproject{Utah FORGE Microseismic Analysis, SPE Geothermal Datathon}{Second place · 2023 · Four-person team}
\begin{compactitems}
  \item Applied bootstrap ensemble clustering to microseismic events, clustering each resampled realization and aggregating results to interpret event structure.
\end{compactitems}
...
\textbf{Programming and software:} Python, C/C++, NumPy, Pandas, scikit-learn, Plotly, Dash, Git, Linux/shell, MPI, LaTeX.\par
\vspace{2pt}
